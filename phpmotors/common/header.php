...
<div id="wrapper">
    <header>
        <div id="top-header">
            ...
            <a class="my-account" href="/starter-assets/phpmotors/vehicles/index.php?action=vehicleManagement" title="Vehicle Management with PHP Motors" id="vehicleManagement">Vehicle Management </a>
